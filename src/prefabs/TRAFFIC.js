class TRAFFIC extends Phaser.Scene {
    ...
    create() {
        ...
        this.physics.add.collider(this.trafficGroup, this.player, () => {
    ...
    spawnTraffic() {
        ...
        if (trafficType === "bus") {
            ...
            traffic.setVelocity(0, 1000);
            console.log(`Bus position: ${traffic.x}, ${traffic.y}`);
        } 
        else if (trafficType === "car") {
            traffic = this.physics.add.sprite(laneX, 100, 'cars').setScale(3);
            traffic.play('car');
            ...
            traffic = this.physics.add.sprite(laneX, 100, 'Biker').setScale(3);
            traffic.play('mf');
